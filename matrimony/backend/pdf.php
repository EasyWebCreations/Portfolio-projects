...
class PDF extends fpdf
{
	...
	function Header()
	{
        ...
        $this->Image('hr.png',20,75,170,0.5,'','');
        $this->Image('hr.png',20,147,170,0.5,'','');
        $this->Image('hr.png',20,162,170,0.5,'','');
        $this->Image('hr.png',20,202,170,0.5,'','');
        $this->Image('hr.png',20,240,170,0.5,'','');

        $this->Image('border.png',10,0,2,400,'','');
        $this->Image('border.png',0,11,210,3,'','');
        $this->Image('border.png',197,0,5,400,'','');
        $this->Image('border.png',0,283,210,3,'','');
        $this->Image('bgh1.png',0,0,10,500,'','');
        $this->Image('bgh1.png',200,0,10,500,'','');
        $this->Image('youthLogo.png', 11, 11, 30,25,'','https://event.akshadaa.com/');
        $this->Image('bgh1.png',0,0,210,12,'','');
        $this->Image('bgh1.png',0,285,210,12,'','');
        // GFG logo image
...
$pdf->SetTextColor(106,36,69);
$pdf->SetFont("Helvetica",'',12);
$pdf->Cell(35,8, $row['mother_tongue'] ,0,0,'');
$pdf->SetTextColor(0,0,0);
$pdf->SetFont("Helvetica",'B',12);
...
$pdf->SetTextColor(106,36,69);
$pdf->SetFont("Helvetica",'',12);
$pdf->Multicell(0,8,$row['c_locality'].", ".$row['c_landmark'].",". $row['c_city'].", ". $row['c_state'] .".",0,1,'');
// $pdf->SetTextColor(0,0,0);
// $pdf->SetFont("Helvetica",'B',12);
...
$pdf->SetTextColor(106,36,69);
$pdf->SetFont("Helvetica",'',12);
$pdf->Cell(35,8,$row['pe_education'],0,0,'');
$pdf->SetTextColor(0,0,0);
$pdf->SetFont("Helvetica",'B',12);
