...
<body>
  ...
  <div class="contentOut">
    ...
    <div class="profile_container">
      ...
      <nav>
        <ul>
          ...
          <li><a href="profile.php" rel="noopener noreferrer" class="active">All People</a></li>
    ...
    <script>
      const searchBar = document.querySelector(".all_users .search input"),
        usersList = document.querySelector(".all_users .usersWrapper");
      ...
      searchBar.onkeyup = () => {
        ...
        if (searchTerm != "") {
          searchBar.classList.add("act1ive");
        } else {
          searchBar.classList.remove("act1ive");
        }
        xhr.open("POST", "back/search.php", true);
        xhr.onload = () => {
      ...
      setInterval(() => {
        ...
        xhr.onload = () => {
          if (xhr.readyState === XMLHttpRequest.DONE) {
            if (xhr.status === 200) {
              let data = xhr.response;
              if (!searchBar.classList.contains("act1ive")) {
                usersList.innerHTML = data;
              }
            }
          }
