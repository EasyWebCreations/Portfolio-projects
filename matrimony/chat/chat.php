...
<body>
  ...
  <div class="contentOut">
    ...
    <div class="profile_container">
      ...
      <div class="all_users">
        <h3>Chat here</h3>
        <div class="chatToAdmin">
          <a href="chatbox.php?id=11111">
            <div class="user_box">
              <div class="user_img"><img src="profile.jpeg" alt="Profile image"></div>
              <div class="user_info"><span>Admin Person</span><br><span style="margin-top: -20px;
                                color: gray;">Chat directly to admin</span>
              </div>
          </a>
        </div>
      </div>
        ...
        <ul>
          ...
          if ($get_frnd_num > 0) {
            foreach ($get_all_friends as $row) {
              echo '<li><a href="chatbox.php?id=' . $row->id . '" ><div class="user_box">
                                <div class="user_img"><img src="profile.jpeg" alt="Profile image"></div>
                                <div class="user_info"><span>' . $row->fname . " " . $row->lname . '</span><br><span style="margin-top: -20px;
                                color: gray;">' . $row->isActive . '</span>
                            </div></a></li>';
            }
          } else {
            echo '<h4>You have no friends to chat!</h4>';
          }
          ?>
