...
// echo  $posted['key'] . "<br>";
// echo $posted['txnid'] . "<br>";
// echo $posted['amount'] . "<br>";
// echo $posted['firstname'] . "<br>";
// echo $posted['email'] . "<br>";
// echo $posted['phone'] . "<br>";
// echo $posted['productinfo'] . "<br>";
// echo $posted['surl'] . "<br>";
// echo $posted['furl'] . "<br>";
// echo $posted['service_provider'] . "<br>";
?>
<html>
  <head>
    <style>
  ...
  <div class="paymentDetails">
    ...
    <form action="<?php echo $action; ?>" method="post" name="payuForm">
      ...
      <table>
        ...
        <tr>
          <td colspan="3"><input type="" name="service_provider" value="payu_paisa" size="64" /></td>
        </tr>
