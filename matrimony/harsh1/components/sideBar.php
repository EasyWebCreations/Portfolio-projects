    ...
    <div class="sideBarTop">
      <div class="sideBarTopImg">
        ...
        <div class="sideBarTopImgEditOut">
          <div class="sideBarTopImgEdit" id="sideBarTopImgEditWide" title="Edit Image" onclick="clickDetect()"></div>
      ...
      <button class="sideBarTopEdit" title="Edit Profile" onclick="window.open(\'settings.php\', target=\'_top\')"></button>
    </div>
    <button class="sideBarCapsule" id="sideBarCapsuleWide" onclick="window.open(\'settings.php\', target=\'_top\')">
      ' . $_SESSION['profileComMsg'] . '
    </button>
    <div class="sideBarTextOut">
      <div class="sideBarTextImgOut"><img class="sideBarTextImg sideBarTextImg1"><a href="index1.php" class="sideBarText" id="sideBarText1">Find Matches</a>
      </div>
      ...
      <div class="sideBarTextImgOut"><img class="sideBarTextImg sideBarTextImg6"><a onclick="peopleILiked(\'1\')" class="sideBarText" id="sideBarText6">People I
          Disliked</a></div>
      <div class="hrStyle"></div>
      <div class="sideBarTextImgOut"><img class="sideBarTextImg sideBarTextImg7"><a href="premium/payment.php" class="sideBarText" id="sideBarText7">Activate Profile</a>
      </div>
    </div>
  </div>
</div>
...
<div class="sideBarMobile">
  <div class="forStickyPosition">
    <div class="sideBarTop" title="View Your Profile">
      ...
      <button class="sideBarTopEdit" onclick="window.open(\'settings.php\', target=\'_top\')"></button>
    </div>
    <div class="sidebarTopButtonOut">
      <div class="sideBarTopImgEditOut">
        <div class="sideBarTopImgEdit" id="sideBarTopImgEditMobile" onclick="clickDetect()"></div>
        <img src="camera.svg" class="sideBarTopImgEdit1">
      </div>
    </div>
    <button class="sideBarCapsule" id="sideBarCapsuleMobile" onclick="window.open(\'settings.php\', target=\'_top\')">
      ' . $_SESSION['profileComMsg'] . '
    </button>
    <div class="sideBarTextOut">
      <div class="sideBarTextImgOut"><img class="sideBarTextImg sideBarTextImg1"><a href="index1.php" class="sideBarText">Find Matches</a>
      </div>
      ...
      <div class="sideBarTextImgOut"><img class="sideBarTextImg sideBarTextImg6"><a onclick="peopleILiked(\'1\')" class="sideBarText">People I
          Disliked</a></div>
      <div class="hrStyle"></div>
      <div class="sideBarTextImgOut"><img class="sideBarTextImg sideBarTextImg7"><a href="premium/payment.php" class="sideBarText">Activate Profile</a>
      </div>
    </div>
  </div>
</div>';
