<?php
    while($row = mysqli_fetch_assoc($query)){
       // echo $row['disliked_to'];
        $sql1 = "SELECT * FROM per_details WHERE id={$row['disliked_to']}";
        ...
        $queryreport = "SELECT * from report where reported_by={$dislikedBy} and reported_to={$row['disliked_to']}";
