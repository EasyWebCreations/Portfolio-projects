...
<body style="background-color: #F7F7F7;">
    ...
    <div class="container-fluid">
        <div class="row">
            <!-- Image -->
            <div class="col-6">
                <img src="img/login.svg" alt="Image " style="width:700px; margin-top: 70px;margin-left:50px; ">
            </div>
            <!-- Login Form -->
            <div class="col-4 login-card">
                <h3>Sign into your account...</h3>
                <form action="login.php" method="POST">
                    <div class="form-group"><label>Username</label><input name="userid" type="text" class="form-control" placeholder="" value="" /></div>
                    <div class="form-group"><label>Password</label><input name="password" type="password" class="form-control" placeholder="" value="" /></div>
                    <div class="form-group"><input type="submit" class="btn btn-primary" value="Login" /></div>
                    <div class="form-group"><a href="dashboard.html" class="ForgetPwd">Forget Password?</a></div>
                </form>
            </div>
            <!-- Login Form ends -->
        </div>
