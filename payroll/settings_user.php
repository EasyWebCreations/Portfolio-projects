...
$sql_all_emp = "SELECT * FROM  emp_details GROUP BY DESIGNATION ORDER BY EMP_ID ASC";
...
<body>
    <!-- Header start -->
    <nav class="navbar navbar-dark" style="background-color: #294FCC;width: 100%;height: 70px;">
    ...
    <!-- Sidebar Menu-->
    <div class="w3-sidebar w3-bar-block w3-card " style="width:300px; position:fixed">
        <div class="admin-image" style="background-color: #D8DBF2; text-align: center; ">
            <img src="img/data_manager.svg" alt="" style="width:200px; margin:20px 45px">
            <h3 style="margin-top: -15px;color: black;"><b>Data Manager</b></h3>
        </div>
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    ...
                                    <div class="modal-content" style="border-radius:20px;">
                                        ...
                                        <div class="modal-body" style="margin:10px;border: 5px solid #646561;border-radius: 30px; ">
                                            ...
                                            <form class="form" method="post" action="fromSettings_user.php">
                                                <!-- Steps -->
                                                <div class="form">
                                                    <div class="input-group row">
                                                        <label class="col" for="username ">Emp_ID</label>
                                                        <input class="col" type="text" name="EMP_ID" value="<?= $row['EMP_ID'] ?>" />
                                                    </div>
                                                    <div class="row">
                                                        <p></p>
                                                    </div>
                                                    <div class="input-group row">
                                                        ...
                                                        <input class="col" type="text " name="SITE_ID" value="<?= $row['SITE_ID'] ?>" />
                                                    </div>
                                                    <div class="row">
                                                        <p></p>
                                                    </div>
                                                    <div class="input-group row">
                                                        ...
                                                        <input class="col" type="text " name="EMP_NAME" value="<?= $row['EMP_NAME'] ?>" />
                                                    </div>
                                                    <div class="row">
                                                        <p></p>
                                                    </div>
                                                    <div class="input-group row">
                                                        ...
                                                        <input class="col" type="text " name="EMP_MOBILE" value="<?= $row['EMP_MOBILE'] ?>" />
                                                    </div>
                                                    <div class="row">
                                                        <p></p>
                                                    </div>
                                                    <div class="input-group row" style="display: flex; ">
                                                        ...
                                                        <input class="col" type="text " name="EMP_ADDRESS" value="<?= $row['EMP_ADDRESS'] ?>" />
                                                    </div>
                                                    <div class="row">
                                                        <p></p>
                                                    </div>
                                                    <div class="input-group row">
                                                        ...
                                                        <input class="col" type="text" name="AADHAR" value="<?= $row['AADHAR'] ?>" />
                                                    </div>
                                                    <div class="row">
                                                        <p></p>
                                                    </div>
                                                    <div class="input-group row" style="display: flex; ">
                                                        ...
                                                        <input class="col" type="text" name="UAN_NO" value="<?= $row['UAN_NO'] ?>" />
                                                    </div>
                                                    <div class="row">
                                                        <p></p>
                                                    </div>
                                                    <div class="input-group row">
                                                        ...
                                                        <input class="col" type="text" name="ESIC_NO" value="<?= $row['ESIC_NO'] ?>" />
                                                    </div>
                                                    <div class="row">
                                                        <p></p>
                                                    </div>
                                                    <div class="input-group row" style="display: flex; ">
                                                        ...
                                                        <input class="col" type="text" name="BANK_AC_NO" value="<?= $row['BANK_AC_NO'] ?>" />
                                                    </div>
                                                    <div class="row">
                                                        <p></p>
                                                    </div>
                                                    <div class="input-group row">
                                                        ...
                                                        <input class="col" type="text" name="IFSC_CODE" value="<?= $row['IFSC_CODE'] ?>" />
                                                    </div>
                                                    <div class="row">
                                                        <p></p>
                                                    </div>
                                                    <div class="input-group row" style="display: flex; ">
                                                        ...
                                                        <input class="col" type="text" name="BNK_NAME" value="<?= $row['BNK_NAME'] ?>" />
                                                    </div>
                                                    <div class="row">
                                                        <p></p>
                                                    </div>
                                                    <div class="input-group row">
                                                        ...
                                                        <input class="col" type="text" name="BNK_ADDRESS" value="<?= $row['BNK_ADDRESS'] ?>" />
                                                    </div>
                                                    <div class="row">
                                                        <p></p>
                                                    </div>
                                                    <div class="input-group row" style="display: flex; ">
                                                        ...
                                                        <input class="col" type="text" name="DESIGNATION" value="<?= $row['DESIGNATION'] ?>" />
                                                    </div>
                                                    <div class="row">
                                                        <p></p>
                                                    </div>
                                                    <div class="input-group row">
                                                        ...
                                                        <input class="col" type="text" name="CATEGORY" value="<?= $row['CATEGORY'] ?>" />
                                                    </div>
                                                    <div class="row">
                                                        <p></p>
                                                    </div>
                                                    <div class="input-group row" style="display: flex; ">
                                                        ...
                                                        <input class="col" type="text" name="BASIC_SAL" value="<?= $row['BASIC_SAL'] ?>" />
                                                    </div>
                                                    <div class="row">
                                                        <p></p>
                                                    </div>
                                                    <div class="input-group row">
                                                        ...
                                                        <input class="col" type="text" name="HRA_SAL" value="<?= $row['HRA_SAL'] ?>" />
                                                    </div>
                                                    <div class="row">
                                                        <p></p>
                                                    </div>
                                                    <div class="input-group row" style="display: flex;">
                                                        ...
                                                        <input class="col" type="text" name="SPL_ALLOW" value="<?= $row['ALLOW'] ?>" />
                                                    </div>
                                                    <div class="row">
                                                        <p></p>
                                                    </div>
                                                    <input type="hidden" name="STATUS" value="<?= $row['STATUS'] ?>" />
                                                    <input id="update_emp" type="submit" name="submit" value="Submit" class="btn btn-success" />
                                                </div>
