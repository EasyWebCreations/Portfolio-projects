...
$sql_all_emp = "SELECT * FROM  emp_details";
...
if (isset($_POST["EMP_ID"])) {
    ...
    if (mysqli_query($conn, $update_emp_sql)) {
        ...
        echo "<script src='js/sweetalert.min.js'></script>
        <script>alert('oooo');swal('Oh no!','Can not update the record','error');</script>";
    } // header("Refresh");
...
<body>
    ...
    <div class="w3-sidebar w3-bar-block w3-card " style="width:300px; position:fixed">
        <div class="admin-image" style="background-color: #D8DBF2; text-align: center; ">
            <img src="img/Group 18.png" alt="" style="width:200px; margin:20px 45px">
    ...
    <div style="margin-left:330px ">
        ...
        <div id="Tokyo " class="w3-container city " style="display:none ">
            <div class="alert alert-primary alert-dismissible" id="success_pass_change" style="display:none;">
                <a href="#" class="close" data-dismiss="alert" aria-label="close">×</a>
            </div>
    ...
    <script src="js/bootstrap_3.4.1_bootstrap.min.js"></script>
    <script src="js/ajax_jquery_3.2.1_jquery.min.js"></script>
